  ...
  <ClientOnly>
    <Dialog v-model:open="dialogOpen">
      ...
      <DialogContent class="sm:max-w-2xl">
        <DialogHeader>
          <DialogTitle class="text-xl">选择存储方式开始使用</DialogTitle>
          <DialogDescription>
        ...
        <div class="grid gap-4 sm:grid-cols-2 pt-2">
          <!-- 本地存储 -->
          <div class="border rounded-xl p-5 flex flex-col gap-3 bg-card transition-all hover:border-foreground/30 hover:shadow-md">
            <div class="flex gap-2 items-center text-foreground">
            ...
            <ul class="text-sm space-y-1.5 text-muted-foreground">
              <li class="flex gap-1.5 items-start">
                <i class="i-ri-checkbox-circle-line mt-0.5 text-green-500 flex-none" />
              ...
              <li class="flex gap-1.5 items-start">
                <i class="i-ri-information-line mt-0.5 text-muted-foreground/80 flex-none" />
          ...
          <div class="border rounded-xl p-5 flex flex-col gap-3 bg-card transition-all hover:border-foreground/30 hover:shadow-md">
            <div class="flex gap-2 items-center text-foreground">
              ...
              <h3 class="text-lg font-semibold">云端存储</h3>
            </div>
            <ul class="text-sm space-y-1.5 text-muted-foreground">
              <li class="flex gap-1.5 items-start">
                <i class="i-ri-checkbox-circle-line mt-0.5 text-green-500 flex-none" />
              ...
              <li class="flex gap-1.5 items-start">
                <i class="i-ri-shield-check-line mt-0.5 text-muted-foreground/80 flex-none" />
            ...
            <AlertDialogHeader>
              ...
              <AlertDialogDescription as-child>
                <div class="space-y-3 text-sm">
                  ...
                  <div v-if="pendingIsLocal" class="p-3 rounded-md bg-muted border">
                  ...
                  <div v-if="pendingRequiresAuth" class="p-3 rounded-md bg-muted border">
                    <p class="font-medium flex gap-1.5 items-center">
                  ...
                  <p class="text-muted-foreground">确认继续吗？</p>
                </div>
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
              <AlertDialogCancel @click="cancelConfirm">取消</AlertDialogCancel>
              <!--
    ...
    <Dialog v-model:open="showSignInDialog">
      <DialogContent class="sm:max-w-md">
        <DialogHeader>
          <DialogTitle class="text-lg">登录账号以使用云端存储</DialogTitle>
        </DialogHeader>
        <div class="pt-2">
    ...
    <template #fallback>
      <div
        class="text-lg text-white leading-[48px] font-semibold mx-auto mt-10 text-center rounded-4xl h-12 w-40 select-none shadow-md from-black to-gray-700 bg-linear-to-r opacity-80 animate-pulse"
      >
        &nbsp;
      </div>
    </template>
