...
export const useResumeSettingsStore = defineStore('resumeSettings', () => {
  ...
  let currentSettings = reactive<ResumeSettings>(getDefaultSettings())
  ...
  async function updateImagePosition(newPosition: Partial<ResumeSettings['imagePosition']>) {
    await updateCurrentSettings({ imagePosition: { ...currentSettings.imagePosition, ...newPosition } })
  }
  ...
  async function saveCurrentSettings() {
    await updateCurrentSettings(currentSettings)
  }
